...
class test_model extends CI_Model 
{
    ...
    public function add_category($info ,$id = '')
    {
        ...
        $this->db->insert( 'test_category', $info );
        $id = $this->db->insert_id();
		}else{
        $this->db->where( 'id', $id );
        // UPDATE DATA get_category
        $this->db->update( 'test_category', $info );
		}
	...
	public function get_subcategory( $id = '' , $type = 'object' )
    {
		if($id!='')
	    $this->db->where( 'id', $id );
        $query = $this->db->get( 'test_subcategory' );
        if ( $type == 'object' ) 
        {
            $data = $query->row();
        }
    ...
    public function add_subcategory($info ,$id = '')
    {
        ...
        $this->db->insert( 'test_subcategory', $info );
        $id = $this->db->insert_id();
		}else{
        $this->db->where( 'id', $id );
        // UPDATE DATA get_subcategory
        $this->db->update( 'test_subcategory', $info );
		}
    ...
    public function del_subcategory( $id = '')
    {
        ...
        $this->db->where( 'id', $id );
        $this->db->delete( 'test_subcategory' );
    ...
    public function get_gallery( $id = '' , $type = 'object' )
    {
        ...
        $query = $this->db->get( 'test_gallery' );
    ...
    public function add( $info = '' )
    {
        ...
        foreach ( $info['title'] as $key => $value ) {
            ...
            $this->db->set( 'test_id', $last_id );
            $this->db->insert( 'test_detail' );
    ...
    public function get_list()
    {
        ...
        $this->db->from( 'test_config AS nc' );
        $this->db->join( 'test_detail AS nd', 'nc.id = nd.test_id', 'left' );
    ...
    {
        $this->db->where( 'id', $id );
        $query = $this->db->get( 'test_config' );
        $data_config = $query->row();

        $this->db->where( 'test_id', $id );
        $query = $this->db->get( 'test_detail' );
        $data = $query->result();
        ...
        $info['test_date'] = date( 'd/m/Y' , $data_config->test_date );
