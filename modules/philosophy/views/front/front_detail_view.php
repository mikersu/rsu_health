            ...
            <article>
            	<div class="container header_page">
                    ...
                    <div class="breadcrumb">
						...
						<a href="<?php echo site_url('philosophy');?>"><?php echo lang_get('Philosophy'); ?></a>
                        <a href="<?php echo site_url('philosophy/detail/'.$show_data['id']);?>" class="active"><?php echo $show_data['title'];?></a>
                    </div>
                </div>
                <div class="main_content default detail" id="philosophy">
                    <div class="container">
						<div class="head">
                            <h1>
                                <span class="Helve_BdC page_name"><?php echo $show_data['title'];?></span>
                                <span class="date"><?php echo date('d/m/Y',$show_data['philosophy_date']);?></span>
                            </h1>
                            <?php
							// $next='';
							// $previous='';
							...
							// 			$next='<a href="'.site_url('philosophy/detail/'.$value->id).'" class="Helve_M">'.lang_get('Philosophy Previous').'</a>';
							...
							// 		if($previous==''){
							// 			if($value->order_sort < $show_data['order_sort']){
							// 			$previous='<a href="'.site_url('philosophy/detail/'.$value->id).'" class="Helve_M">'.lang_get('Philosophy Next').'</a>';
							// 			}
							// 		}
							...
							// 	if($previous=='')
							// 	$previous='<a href="javascript:void(0);" class="Helve_M disable">'.lang_get('Philosophy Previous').'</a>';
							// 	echo $previous;
							// 	if($next=='')
							// 	$next='<a href="javascript:void(0);" class="Helve_M disable">'.lang_get('Philosophy Next').'</a>';
							// 	echo $next;
							// 	echo '</div>';
							// }
                            ...
                            foreach ( $data_list as $key => $value ) {
                                ...
                                if ( $value->philosophy_id == $show_data['philosophy_id'] ) {
                                    
                                    if ( ! empty( $data_list[$key-1]->philosophy_id ) ) {
                                        echo $Previous='<a href="'.site_url('philosophy/detail/'.$data_list[$key-1]->philosophy_id).'" class="Helve_M">'.lang_get('Philosophy Previous').'</a>';
                                    }
                                    if ( ! empty( $data_list[$key+1]->philosophy_id ) ) {
                                        echo $next = '<a href="'.site_url('philosophy/detail/'.$data_list[$key+1]->philosophy_id).'" class="Helve_M">'.lang_get('Philosophy Next').'</a>';
                                    }
