			...
			<div class="tab-content">
				<div class="portlet box blue">
					...
					<div class="portlet-body form">
						...
						<?php echo form_open( site_url('site-admin/service/mark_sort_service') , $attributes); ?>

						<div class="portlet-body">
							<div class="clearfix">
								<div class="btn-group">
									<a class="btn green" href="<?php echo site_url( 'site-admin/service/category_add/') ?>"> 
								...
								<tbody>
									...
									<?php foreach ( $data_list as $key => $value ): ?>
										<tr class="">
											...
											<td> 
												<?php $object_image = json_decode($value->image);?>
												<?php foreach ( $object_image as $key_image => $value_image ): ?>
													<img style="height: 4em;" src="<?php echo base_url( $value_image ) ?>" alt="logo image">
												<?php endforeach ?>
											</td>
											<td style="width: 258px;">
												
												<a title="Edit" class="btn mini purple" href="<?php echo site_url( 'site-admin/service/category_edit/'.$value->id ) ?>">
													<i class="icon-edit"></i>
													Edit
												</a>

												<a data-url="<?php echo site_url( 'site-admin/service/service_delete/'.$value->id ) ?>" class="delete_data btn mini black" href="javascript:;">
													<i class="icon-trash"></i>
													Delete
												</a>

												<a class="btn mini blue" href="<?php echo site_url( 'site-admin/service/list_item/'.$value->id ) ?>">
													<i class="icon-cogs"></i>
													Management Data
												</a>
