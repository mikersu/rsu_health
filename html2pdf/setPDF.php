...
$pdf->SetAuthor('System Bizidea'); // ชื่อผู้สร้างไฟล์ PDF
$pdf->SetTitle('Application Jobs');//  กำหนด Title
$pdf->SetSubject('Application Jobs'); // กำหนด Subject
$pdf->SetKeywords('Application Jobs'); // กำหนด Keyword
...
//$pdf->SetHeaderData(PDF_HEADER_LOGO, PDF_HEADER_LOGO_WIDTH, 'บริษัท ไอเดียคอรเปอร์เรชั่น (2006) จำกัด', PDF_HEADER_STRING);
