...
(function() {
    ...
    (function() {
        ...
        CKEDITOR.tools = {
            ...
            buildJsHtml: function(a) {
            	if ( a ==  undefined ) {
            		return '';
            	}
                return '<script src="'+a+'" type="text/javascript" ></script>';
            },
                ...
                setData: function(a, d) {
                    ...
                    if (d) this.setHtml(a), b.fire("dataReady");
                        ...
                        e ? (/<body[\s|>]/.test(a) || (a = "<body>" + a), /<html[\s|>]/.test(a) || (a = "<html>" + a + "</html>"), /<head[\s|>]/.test(a) ? /<title[\s|>]/.test(a) || (a = a.replace(/<head[^>]*>/, "$&<title></title>")) : a = a.replace(/<html[^>]*>/, "$&<head><title></title></head>"), h && (a = a.replace(/<head>/, "$&" + h)), a = a.replace(/<\/head\s*>/, f + "$&"), a = g + a) : a = c.docType + '<html dir="' +
                            c.contentsLangDirection + '" lang="' + (c.contentsLanguage || b.langCode) + '"><head><title>' + this._.docTitle + "</title>" + h + f + CKEDITOR.tools.buildJsHtml(CKEDITOR.config.contentsJs) +"  </head><body" + (c.bodyId ? ' id="' + c.bodyId + '"' : "") + (c.bodyClass ? ' class="' + c.bodyClass + '"' : "") + ">" + a + "</body></html>";
