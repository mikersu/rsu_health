...
class fphilosophy_model extends CI_Model 
{
    ...
    public function calendar_list( $start = '' , $end = '' )
    {
    	...
    	$this->db->where( 'philosophy_date >=', $start );
    	$this->db->where( 'philosophy_date <=', $end );
    ...
    {
        $this->db->from( 'philosophy_config' );
