...
class fhealth_new_model extends CI_Model 
{
    ...
    public function calendar_list( $start = '' , $end = '' )
    {
    	...
    	$this->db->where( 'health_new_date >=', $start );
    	$this->db->where( 'health_new_date <=', $end );
    ...
    {
        $this->db->from( 'health_new_config' );
