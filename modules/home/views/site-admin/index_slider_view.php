			...
			<div class="tab-content">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-body form">
					            ...
					            <?php echo form_open( site_url('site-admin/home/mark_sort_slider') , $attributes); ?>

				                <div class="portlet-body">
				                    <div class="clearfix">
				                        <div class="btn-group">
				                            <a class="btn green" href="<?php echo site_url( 'site-admin/home/slider_add/') ?>"> 
				                            ...
				                            <?php foreach ( $data_list as $key => $value ): ?>
				                                <tr class="">
				                                    <td style="display:none" ><?php echo $value->order_sort ?></td>
				                                   	<td> 
														<img src="<?php echo base_url( $value->image ) ?>" style="height: 6em;" alt="">
				                                   	</td>
				                                   	<td style="width: 25em;"> 
				                                    ...
				                                    <td style="width: 3em;">
				                                        ...
				                                        <a title="Edit" class="btn mini purple" href="<?php echo site_url( 'site-admin/home/slider_edit/'.$value->id ) ?>">
				                                            <i class="icon-edit"></i>
				                                            Edit
				                                        </a>

														<a data-url="<?php echo site_url( 'site-admin/home/slider_delete/'.$value->id ) ?>" class="delete_data btn mini black" href="javascript:;">
