   ...
   <div class="span12">
	  ...
	  <div class="portlet box blue">
		 <div class="portlet-title">
			<h4><i class="icon-reorder"></i>Detail in SubCategory <?php echo $language->language_name ?></h4>
		 </div>
		 <div class="portlet-body form">
                ...
                <div class="controls">
					...
					foreach($category_list as $key=>$category){
						if($category->language_id==$language_id){
							$category_id = ( ! empty( $show_data['category_id'] ) ) ? $show_data['category_id'] : '' ;
			...
			<div class="form-actions">
				...
				<a class="btn" href="<?php echo site_url('site-admin/qa_evaluation') ?>">Cancel</a>
			</div>
			<?php echo form_close(); ?>
			<!-- END FORM-->
		 </div>
