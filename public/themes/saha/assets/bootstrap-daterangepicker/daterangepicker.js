...
!function ($) {
                ...
                '<div class="ranges">' +
                  '<div class="range_inputs">' +
                    '<div>' +
                      ...
                      '<input class="m-wrap input-mini" type="text" name="daterangepicker_start" value="" />' +
                    '</div>' +
                    '<div>' +
                      '<label for="daterangepicker_end">' + this.locale.toLabel + '</label>' +
                      '<input class="m-wrap input-mini" type="text" name="daterangepicker_end" value="" />' +
                    '</div>' +
    ...
    DateRangePicker.prototype = {
        ...
        notify: function () {
            ...
            var t_date_start = $('#input_date_range').find('input[name=start_date]');  
            var t_date_end = $('#input_date_range').find('input[name=end_date]');

            t_date_start.val(this.startDate.toString(this.format));
            t_date_end.val(this.endDate.toString(this.format));
