                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane <?php echo $active ?>" id="portlet_tab<?php echo $value->id ?>">
                                    ...
                                    <div class="control-group display_none">
                                        ...
                                        <div class="controls">
                                            <input class="m-wrap m-ctrl-medium date-picker" type="text" value="<?php echo $health_new_date = ( ! empty( $show_data['health_new_date'] ) ) ? $show_data['health_new_date'] : '' ; ?>" size="16" readonly="" name="health_new_date">
                                        </div>
                                    </div>
