                        ...
                        <div class="portlet-body form">
                            ...
                            <div class="form-horizontal" >
                                ...
                                <div class="control-group display_none">
                                    ...
                                    <div class="controls">
                                        <input class="m-wrap m-ctrl-medium date-picker" type="text" value="<?php echo $test_date = ( ! empty( $show_data['test_date'] ) ) ? $show_data['test_date'] : '' ; ?>" size="16" readonly="" name="test_date">
                                    </div>
                                </div>
...
<script>
    ...
    CKEDITOR.config.contentsCss = [ 
                                    ...
                                    '<?php echo $this->theme_path."../ape/css/test_editer.css" ?>' ,
