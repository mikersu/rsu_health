			...
			<div class="tab-content">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-body form">
					            ...
					            <?php echo form_open( site_url('site-admin/philosophy/mark_sort_philosophy') , $attributes); ?>

				                <div class="portlet-body">
				                    <div class="clearfix">
				                        <div class="btn-group">
				                            <a class="btn green" href="<?php echo site_url( 'site-admin/philosophy/philosophy_add/') ?>"> 
				                            ...
				                            <?php foreach ( $data_list as $key => $value ): ?>
				                                <tr class="">
				                                    ...
				                                    <td style="width: 3em;">
				                                        ...
				                                        <a title="Edit" class="btn mini purple" href="<?php echo site_url( 'site-admin/philosophy/philosophy_edit/'.$value->id ) ?>">
				                                            <i class="icon-edit"></i>
				                                            Edit
				                                        </a>

														<a data-url="<?php echo site_url( 'site-admin/philosophy/philosophy_delete/'.$value->id ) ?>" class="delete_data btn mini black" href="javascript:;">
