					...
					<div class="tab-pane <?php echo $action = ( $key_lang == 0 ) ? 'active' : '' ; ?>" id="tab_<?php echo $value_lang->id ?>">
						<div class="portlet box blue">
							...
							<div class="portlet-body form">
					            ...
					            <?php echo form_open( site_url('site-admin/philosophy/mark_sort_subcategory') , $attributes); ?>

				                <div class="portlet-body">
				                    <div class="clearfix">
				                        <div class="btn-group">
				                            <a class="btn green" href="<?php echo site_url( 'site-admin/philosophy/add_subcategory/'.$value_lang->id ) ?>"> 
				                        ...
				                        <tbody>
											...
											<tr class="">
				                                    ...
				                                    <td style="width: 3em;">
				                                        ...
				                                        <a title="Edit" class="btn mini purple" href="<?php echo site_url( 'site-admin/philosophy/add_subcategory/'.$value_lang->id.'/'.$value->id ) ?>">
				                                            <i class="icon-edit"></i>
				                                            Edit
				                                        </a>

														<a data-url="<?php echo site_url( 'site-admin/philosophy/del_subcategory/'.$value->id ) ?>" class="delete_data btn mini black" href="javascript:;">
