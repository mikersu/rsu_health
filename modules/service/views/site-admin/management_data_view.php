			...
			<div class="tab-content">			
						<div class="portlet box blue">
							...
							<div class="portlet-body form">
					            ...
					            <?php echo form_open( site_url('site-admin/service/mark_sort_list_item/'.$category_id) , $attributes); ?>

				                <div class="portlet-body">
				                    <div class="clearfix">
				                        <div class="btn-group">
				                            <a class="btn green" href="<?php echo site_url( 'site-admin/service/add_list_item/'.$category_id ) ?>"> 
				                            ...
				                            <?php foreach ( $data_list as $key => $value ): ?>
				                                <tr class="">
				                                    <td style="display:none" ><?php echo $value->order_sort ?></td>
				                                   	<td> 
														<img style="height: 4em;" src="<?php echo base_url( $value->image ) ?>" alt="logo image">
				                                   	</td>
				                                   	<td> 
				                                    ...
				                                    <td>
				                                        ...
				                                        <a title="Edit" class="btn mini purple" href="<?php echo site_url( 'site-admin/service/edit_list_item/'.$category_id.'/'.$value->id ) ?>">
				                                            <i class="icon-edit"></i>
				                                            Edit
				                                        </a>

														<a data-url="<?php echo site_url( 'site-admin/service/list_item_delete/'.$value->id ) ?>" class="delete_data btn mini black" href="javascript:;">
