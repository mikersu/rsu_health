                    ...
                    <div class="portlet box blue">
                        ...
                        <div class="portlet-body form">
                            ...
                            <div class="form-horizontal" >
                                ...
                                <!-- END VIDEO COVER -->
                                <div class="control-group display_none">
                                    <label class="control-label">Philosophy Date</label>

                                    <div class="controls">
                                        <input class="m-wrap m-ctrl-medium date-picker" type="text" value="<?php echo $philosophy_date = ( ! empty( $show_data['philosophy_date'] ) ) ? $show_data['philosophy_date'] : '' ; ?>" size="16" readonly="" name="philosophy_date">
                                    </div>
                                </div>
...
<script>
    ...
    CKEDITOR.config.contentsCss = [ 
                                    ...
                                    '<?php echo $this->theme_path."../ape/css/philosophy_editer.css" ?>' ,
