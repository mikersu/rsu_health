      ...
      <div class="link-group">
         <div class="head">
            <ol class="breadcrumb" style="padding-left: 10px;">
               <li><a href="health_new">จุลสารสุขภาพกาย</a></li>
            </ol>
         </div>
         <div class="link-page">
            <ol class="breadcrumb">
               <li><a href="index">หน้าแรก</a></li>
               <li class="active"><a href="javascript:void(0)">จุลสารสุขภาพกาย</a></li>
            </ol>
         </div>
      </div>
               ...
               <nav>
                  <ul class="nav nav-pills nav-stacked">
                     <?php foreach ( $data_list as $key => $value ): ?>
                        <li <?php echo $retVal = ( ! empty( $value->hover ) ) ? $value->hover : '' ; ?> ><a href="<?php echo site_url( 'health_new/'.$value->slug ) ?>"><?php echo $value->title ?></a></li>
                     <?php endforeach ?>
                  </ul>
               </nav>
            </div>        
