					...
					<div class="tab-pane <?php echo $action = ( $key_lang == 0 ) ? 'active' : '' ; ?>" id="tab_<?php echo $value_lang->id ?>">
						<div class="portlet box blue">
							...
							<div class="portlet-body form">
					            ...
					            <?php echo form_open( site_url('site-admin/health_new/mark_sort_category') , $attributes); ?>

				                <div class="portlet-body">
				                    <div class="clearfix">
				                        <div class="btn-group">
				                            <a class="btn green" href="<?php echo site_url( 'site-admin/health_new/add_category/'.$value_lang->id ) ?>"> 
				                        ...
				                        <tbody>
											...
											<tr class="">
				                                    ...
				                                    <td style="width: 3em;">
				                                        ...
				                                        <a title="Edit" class="btn mini purple" href="<?php echo site_url( 'site-admin/health_new/add_category/'.$value_lang->id.'/'.$value->id ) ?>">
				                                            <i class="icon-edit"></i>
				                                            Edit
				                                        </a>

														<a data-url="<?php echo site_url( 'site-admin/health_new/del_category/'.$value->id ) ?>" class="delete_data btn mini black" href="javascript:;">
